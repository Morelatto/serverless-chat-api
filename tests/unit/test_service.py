...
class TestResponseCache:
    ...
    def test_cache_expiration(self):
        ...
        # Mock time passing
        with patch('src.chat.service.datetime') as mock_datetime:
...
class TestChatService:
    ...
    def mock_dependencies(self):
        ...
        with patch('src.chat.service.DatabaseInterface') as mock_db, \
            ...
            mock_llm_instance.generate = AsyncMock(return_value={
