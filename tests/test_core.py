...
async def test_process_message(mock_call_llm: AsyncMock, mock_get_cached: AsyncMock, mock_save: AsyncMock, mock_set_cached: AsyncMock) -> None:
...
@patch('chat_api.core._call_llm')
@patch('chat_api.core.storage_health')
async def test_health_check_llm_failure(mock_storage_health: AsyncMock, mock_call_llm: AsyncMock) -> None:
...
@patch('chat_api.core._call_llm')
@patch('chat_api.core.storage_health')
async def test_health_check_storage_failure(mock_storage_health: AsyncMock, mock_call_llm: AsyncMock) -> None:
...
@patch('chat_api.core.get_cached')
async def test_process_message_cache_key_generation(mock_get_cached: AsyncMock, mock_cache_key: AsyncMock) -> None:
    ...
    with patch('chat_api.core._call_llm', side_effect=Exception("Stop here")):
...
async def test_call_llm_error_handling(mock_call_llm: AsyncMock) -> None:
    ...
    with patch('chat_api.core.get_cached', return_value=None):
...
@patch('chat_api.core.get_cached')
@patch('chat_api.core._call_llm')
async def test_process_message_full_flow(mock_call_llm: AsyncMock, mock_get_cached: AsyncMock, mock_save: AsyncMock, mock_set_cached: AsyncMock) -> None:
